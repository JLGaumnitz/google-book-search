        ...
        <Row>
          <Col size="md-12">
            <Jumbotron>
              ...
              <h2 className="text-center">Find a book by entering a title and pressing "Search." Then in the Results window below, press "View" to learn more. Press "Save" to build a list to peruse later. Happy Reading!!</h2>
            </Jumbotron>
          </Col>
          <Col size="md-12">
